...
def test_build_title_block_pdf():
    ...
    build_title_block_pdf(document_issue=document_issue, fpth_output=FPTH_TITLE_BLOCK_PDF)
...
def test_build_schedule_title_page_template_pdf():
    ...
    build_schedule_title_page_template_pdf(document_issue=document_issue, fpth_output=FPTH_SCHEDULE_TITLE_PAGE_PDF)
