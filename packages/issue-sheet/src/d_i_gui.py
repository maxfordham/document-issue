...
class DialogWindow(MFTk):
    ...
    def __init__(self, parent):
        ...
        self.lookup, self.projectinfo, self.config, self.data, self.li_issues, self.doc_revs, self.doc_descriptions, self.doc_issues, self.dist_data = read_excel()
    ...
    def save(self):
        ...
        filescreated = BuildIssueSheet.print_issue_and_issue_history(self.data, self.dist_data, self.projectinfo, self.lookup, self.config, self.doc_descriptions, selected_issues, column_widths, project_name, office, max_cols_in_part, self.li_issues, project_code)
